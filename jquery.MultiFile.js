            ...
            .each(function () {
                ...
                MultiFile.addSlave = function (slave, slave_count) {
                    ...
                    slave.change(function(a,b,c) {
                      ...
                      if(window.console) console.log('MultiFile.slave.change',arguments);
                      if(window.console) console.log('MultiFile.slave.change',a);
                      if(window.console) console.log('MultiFile.slave.change',b);
                      if(window.console) console.log('MultiFile.slave.change',c);
                      ...
                      //# NEW 2014-04-14 - accpet multiple file selection, HTML5
                      var files = this.files || [{name:this.value,size:0,type:((this.value||'').match(/[^\.]+$/i)||[''])[0]}],
                      ...
                      // file size label function
                      function sl(x){ return x>1048576? (x/1048576).toFixed(1)+'Mb' : (x/1048576).toFixed(1)+'Kb' };
                      
                      // limit the max size of files selected
                      if (MultiFile.maxsize){
                        if(total_size>MultiFile.maxsize){
                      ...
                      if (ERROR.length>0) {
                        ...
                        // Emulate "multiple" selection with a new element?
                        //if(!html5_multi_mode){
